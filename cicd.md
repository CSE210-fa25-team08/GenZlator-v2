...
3. Build
    ...
    * These commands are exectued by a Github Action Cloud Runner that creates a temporary VM and tests the build
    * **Status: This setup has been completed**

4. Testing
    * There are two types of testing that will run in parralel. Both testings must pass before moving to the next step. 
        * Unit Testing
        ...
        * Integration Testing
            * This phase will test to see if the different componenets of the porject work together as a group. This test will include calls from the database and APIs to ensure that the integrations are working as intended. 
...
6. Build Container Image
    * This phase packages the application and all dependencies into a portable container. This guarentees concistency across all enviornments and eliminates dependency issues. 
...
10. Deploy to Production
    ...
    * **Status: This step has been complete.**