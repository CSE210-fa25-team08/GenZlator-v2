...
async def get_available_models():
    ...
    model_details = {
        ...
        "deepseek/deepseek-r1-distill-llama-70b:free": {
            ...
            "provider": "DeepSeek",
            "max_tokens": 4096,
            "strengths": ["Good performance", "Faster than full model", "Efficient processing"]
        },
        "cognitivecomputations/dolphin3.0-mistral-24b:free": {
            ...
            "max_tokens": 4096,
            "strengths": ["Creative responses", "Good for conversation", "Emoji understanding"]
        },
        "cognitivecomputations/dolphin-mistral-24b-venice-edition:free": {
            ...
            "provider": "Cognitive Computations", 
            "max_tokens": 4096,
            "strengths": ["Enhanced creativity", "Better context understanding", "Improved emoji translation"]
        }
    }
...
async def get_model_details(model_id: str):
    ...
    if model_id not in FREE_MODELS:
        ...
        raise HTTPException(status_code=404, detail=f"Model {model_id} not found or not supported")
    ...
    model_details = {
        "mistralai/mistral-7b-instruct:free": {
            ...
            "max_tokens": 4096,
            "strengths": ["Fast response", "Good instruction following", "Multilingual support"],
            "use_cases": ["Text to emoji translation", "Emoji to text translation", "Contextual understanding"],
        ...
        "deepseek/deepseek-r1:free": {
            ...
            "max_tokens": 8192,
            "strengths": ["Strong reasoning", "Complex task handling", "High accuracy"],
            "use_cases": ["Complex translation scenarios", "Context-aware translations", "Nuanced emoji interpretation"],
        ...
        "deepseek/deepseek-r1-distill-llama-70b:free": {
            ...
            "max_tokens": 4096,
            "strengths": ["Good performance", "Faster than full model", "Efficient processing"],
            "use_cases": ["Balanced translation quality", "Standard use cases", "Good fallback option"],
        ...
        "cognitivecomputations/dolphin3.0-mistral-24b:free": {
            ...
            "max_tokens": 4096,
            "strengths": ["Creative responses", "Good for conversation", "Emoji understanding"],
            "use_cases": ["Creative emoji combinations", "Conversational context", "Expressive translations"],
        ...
        "cognitivecomputations/dolphin-mistral-24b-venice-edition:free": {
            ...
            "max_tokens": 4096,
            "strengths": ["Enhanced creativity", "Better context understanding", "Improved emoji translation"],
            "use_cases": ["Advanced emoji interpretation", "Creative text generation", "Context-rich translations"],
