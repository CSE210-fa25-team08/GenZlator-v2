...
from models import TranslateRequest, TranslateResponse, TranslateResponseMetadata
...
async def translate(req: TranslateRequest):
    ...
    if similar_feedbacks:
        ...
        similar_examples_formatted = prompt_manager.format_similar_examples(similar_feedbacks)
        ...
        conversion_desc = prompt_manager.prompts["prompts"]["system_prompts"]["base_translator"]["variants"][direction]
